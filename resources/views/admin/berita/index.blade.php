...
<div class="page-header" style="display: flex; justify-content: space-between; align-items: center;">
    ...
    <a href="{{ route('admin.berita.create') }}" class="btn btn-primary">
        <i data-feather="plus-circle"></i> Tambah Berita
    </a>
</div>
...
<div class="card-grid" style="grid-template-columns: 1fr;">
        ...
        <div class="dashboard-card" style="display: flex; flex-direction: row; align-items: flex-start; gap: 1.5rem; padding: 1.5rem;">
            ...
            <div style="flex: 1; display: flex; flex-direction: column; justify-content: space-between; height: 100%;">
                ...
                <div class="action-group">
                    <a href="{{ route('admin.berita.show', $item->id) }}" class="btn btn-secondary" style="padding: 0.4rem 1rem; font-size: 0.85rem;">
                        Lihat
                    </a>
                    
                    <a href="{{ route('admin.berita.edit', $item->id) }}" class="btn btn-secondary" style="padding: 0.4rem 1rem; font-size: 0.85rem;">
                        Edit
                    </a>
    ...
    @empty
        <div class="dashboard-card" style="justify-content: center; text-align: center; padding: 4rem;">
            <div>
                <i data-feather="file-text" style="width: 48px; height: 48px; color: var(--text-muted); margin-bottom: 1rem;"></i>
