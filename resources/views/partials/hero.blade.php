...
<section class="relative overflow-hidden bg-gradient-to-r from-indigo-900 via-indigo-700 to-indigo-900 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-white text-center py-20 sm:py-28 pt-32 sm:pt-40">
